...
public class PanelGradiente extends JLayeredPane {
    ...
    private Paint getGradientePaint() {
        ...
        switch (this.gradiente) {
            ...
            case AQUA:
                return new LinearGradientPaint(0.0F, 0.0F, 0.0F, getHeight(), new float[]{0.0F, 0.3F, 0.5F, 1.0F}, new Color[]{this.colorPrimario.brighter().brighter(),
                    this.colorPrimario.brighter(), this.colorSecundario.darker().darker(), this.colorSecundario.darker()});
        }
